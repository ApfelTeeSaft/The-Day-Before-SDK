...
public:
	...
	uint8                                         Pad_9[0x1E7];                                      // 0x0009(0x01E7)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FVertexPainthWithinArea_ComponentToCheckIfIsWithinInfo) == 0x0001F0, "Wrong size on FVertexPainthWithinArea_ComponentToCheckIfIsWithinInfo");
...
{
public:
	class AActor*                                 IfVertexHasLineOfSightToActor;                     // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                IfVertexHasLineOfSightToPosition;                  // 0x0008(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceFromVertexPositionToStartTrace;            // 0x0020(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      CheckLineOfSightAgainstObjectTypes;                // 0x0028(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          IgnoreMeshActorTryingToApplyPaintOn;               // 0x0038(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         LineOfSightTraceActorsToIgnore;                    // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexDetectPaintColorCondition_HasLineOfSightStruct) == 0x000050, "Wrong size on FVertexDetectPaintColorCondition_HasLineOfSightStruct");
...
static_assert(offsetof(FVertexDetectPaintColorCondition_HasLineOfSightStruct, IfVertexHasLineOfSightToPosition) == 0x000008, "Member 'FVertexDetectPaintColorCondition_HasLineOfSightStruct::IfVertexHasLineOfSightToPosition' has a wrong offset!");
static_assert(offsetof(FVertexDetectPaintColorCondition_HasLineOfSightStruct, DistanceFromVertexPositionToStartTrace) == 0x000020, "Member 'FVertexDetectPaintColorCondition_HasLineOfSightStruct::DistanceFromVertexPositionToStartTrace' has a wrong offset!");
static_assert(offsetof(FVertexDetectPaintColorCondition_HasLineOfSightStruct, CheckLineOfSightAgainstObjectTypes) == 0x000028, "Member 'FVertexDetectPaintColorCondition_HasLineOfSightStruct::CheckLineOfSightAgainstObjectTypes' has a wrong offset!");
static_assert(offsetof(FVertexDetectPaintColorCondition_HasLineOfSightStruct, IgnoreMeshActorTryingToApplyPaintOn) == 0x000038, "Member 'FVertexDetectPaintColorCondition_HasLineOfSightStruct::IgnoreMeshActorTryingToApplyPaintOn' has a wrong offset!");
static_assert(offsetof(FVertexDetectPaintColorCondition_HasLineOfSightStruct, LineOfSightTraceActorsToIgnore) == 0x000040, "Member 'FVertexDetectPaintColorCondition_HasLineOfSightStruct::LineOfSightTraceActorsToIgnore' has a wrong offset!");
...
// ScriptStruct VertexPaintDetectionPlugin.VertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation
// 0x0028 (0x0028 - 0x0000)
struct FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation final
{
public:
	bool                                          OnlyAffectVerticesWithDirectionToActorOrLocation;  // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinDotProductToActorOrLocation;                    // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation) == 0x000008, "Wrong alignment on FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation");
static_assert(sizeof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation) == 0x000028, "Wrong size on FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation");
static_assert(offsetof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation, OnlyAffectVerticesWithDirectionToActorOrLocation) == 0x000000, "Member 'FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation::OnlyAffectVerticesWithDirectionToActorOrLocation' has a wrong offset!");
static_assert(offsetof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation, MinDotProductToActorOrLocation) == 0x000004, "Member 'FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation::MinDotProductToActorOrLocation' has a wrong offset!");
static_assert(offsetof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation, Actor) == 0x000008, "Member 'FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation::Actor' has a wrong offset!");
static_assert(offsetof(FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation, Location) == 0x000010, "Member 'FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation::Location' has a wrong offset!");
...
// ScriptStruct VertexPaintDetectionPlugin.VertexDetectCompareMeshColorsToColorArrayStruct
// 0x0020 (0x0020 - 0x0000)
struct FVertexDetectCompareMeshColorsToColorArrayStruct final
{
public:
	bool                                          CompareMeshColorsToColorArrayAtLOD0;               // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FColor>                         ColorArrayToCompareWith;                           // 0x0008(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         RangeMeshColorHasToBeWithin;                       // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVertexDetectCompareMeshColorsToColorArrayStruct) == 0x000008, "Wrong alignment on FVertexDetectCompareMeshColorsToColorArrayStruct");
static_assert(sizeof(FVertexDetectCompareMeshColorsToColorArrayStruct) == 0x000020, "Wrong size on FVertexDetectCompareMeshColorsToColorArrayStruct");
static_assert(offsetof(FVertexDetectCompareMeshColorsToColorArrayStruct, CompareMeshColorsToColorArrayAtLOD0) == 0x000000, "Member 'FVertexDetectCompareMeshColorsToColorArrayStruct::CompareMeshColorsToColorArrayAtLOD0' has a wrong offset!");
static_assert(offsetof(FVertexDetectCompareMeshColorsToColorArrayStruct, ColorArrayToCompareWith) == 0x000008, "Member 'FVertexDetectCompareMeshColorsToColorArrayStruct::ColorArrayToCompareWith' has a wrong offset!");
static_assert(offsetof(FVertexDetectCompareMeshColorsToColorArrayStruct, RangeMeshColorHasToBeWithin) == 0x000018, "Member 'FVertexDetectCompareMeshColorsToColorArrayStruct::RangeMeshColorHasToBeWithin' has a wrong offset!");
...
public:
	...
	struct FVertexDetectCompareMeshColorsToColorArrayStruct CompareMeshColorsToColorArray;                     // 0x0010(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          IncludeVertexColorData;                            // 0x0030(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IncludeSerializedVertexColorData;                  // 0x0031(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IncludeVertexPositionData;                         // 0x0032(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IncludeVertexNormalData;                           // 0x0033(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVertexDetectEventSettings) == 0x000008, "Wrong alignment on FVertexDetectEventSettings");
static_assert(sizeof(FVertexDetectEventSettings) == 0x000038, "Wrong size on FVertexDetectEventSettings");
...
static_assert(offsetof(FVertexDetectEventSettings, CompareMeshColorsToColorArray) == 0x000010, "Member 'FVertexDetectEventSettings::CompareMeshColorsToColorArray' has a wrong offset!");
static_assert(offsetof(FVertexDetectEventSettings, IncludeVertexColorData) == 0x000030, "Member 'FVertexDetectEventSettings::IncludeVertexColorData' has a wrong offset!");
static_assert(offsetof(FVertexDetectEventSettings, IncludeSerializedVertexColorData) == 0x000031, "Member 'FVertexDetectEventSettings::IncludeSerializedVertexColorData' has a wrong offset!");
static_assert(offsetof(FVertexDetectEventSettings, IncludeVertexPositionData) == 0x000032, "Member 'FVertexDetectEventSettings::IncludeVertexPositionData' has a wrong offset!");
static_assert(offsetof(FVertexDetectEventSettings, IncludeVertexNormalData) == 0x000033, "Member 'FVertexDetectEventSettings::IncludeVertexNormalData' has a wrong offset!");
...
{
public:
	class AActor*                                 Actor;                                             // 0x0000(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectEventSettings             CallbackSettings;                                  // 0x0010(0x0038)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexPaintMultiThreadSettingsStruct  MultiThreadSettings;                               // 0x0048(0x0002)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          IgnoreTaskQueueLimit;                              // 0x004A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexDetectFundementalStruct) == 0x000050, "Wrong size on FVertexDetectFundementalStruct");
...
static_assert(offsetof(FVertexDetectFundementalStruct, MultiThreadSettings) == 0x000048, "Member 'FVertexDetectFundementalStruct::MultiThreadSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectFundementalStruct, IgnoreTaskQueueLimit) == 0x00004A, "Member 'FVertexDetectFundementalStruct::IgnoreTaskQueueLimit' has a wrong offset!");
...
{
public:
	struct FVertexPaintOverridePaintUpToLOD       OverrideLOD;                                       // 0x0050(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          AffectClothPhysics;                                // 0x0058(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         CanOnlyApplyPaintOnTheseActors;                    // 0x0060(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexPaintStruct) == 0x000008, "Wrong alignment on FVertexPaintStruct");
static_assert(sizeof(FVertexPaintStruct) == 0x000070, "Wrong size on FVertexPaintStruct");
static_assert(offsetof(FVertexPaintStruct, OverrideLOD) == 0x000050, "Member 'FVertexPaintStruct::OverrideLOD' has a wrong offset!");
static_assert(offsetof(FVertexPaintStruct, AffectClothPhysics) == 0x000058, "Member 'FVertexPaintStruct::AffectClothPhysics' has a wrong offset!");
static_assert(offsetof(FVertexPaintStruct, CanOnlyApplyPaintOnTheseActors) == 0x000060, "Member 'FVertexPaintStruct::CanOnlyApplyPaintOnTheseActors' has a wrong offset!");
...
{
public:
	struct FVertexDetectRGBAStruct                ApplyVertexColorSettings;                          // 0x0070(0x0100)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexPaintingLimitStruct             LimitPaintColor;                                   // 0x0170(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexPaintOnlyAffectVerticesWithDirectionToActorOrLocation OnlyAffectVerticesWithDirectionToLocation;         // 0x0188(0x0028)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexPaintColorSettingStruct) == 0x000008, "Wrong alignment on FVertexPaintColorSettingStruct");
static_assert(sizeof(FVertexPaintColorSettingStruct) == 0x0001B0, "Wrong size on FVertexPaintColorSettingStruct");
static_assert(offsetof(FVertexPaintColorSettingStruct, ApplyVertexColorSettings) == 0x000070, "Member 'FVertexPaintColorSettingStruct::ApplyVertexColorSettings' has a wrong offset!");
static_assert(offsetof(FVertexPaintColorSettingStruct, LimitPaintColor) == 0x000170, "Member 'FVertexPaintColorSettingStruct::LimitPaintColor' has a wrong offset!");
static_assert(offsetof(FVertexPaintColorSettingStruct, OnlyAffectVerticesWithDirectionToLocation) == 0x000188, "Member 'FVertexPaintColorSettingStruct::OnlyAffectVerticesWithDirectionToLocation' has a wrong offset!");
...
{
public:
	TArray<struct FVertexPainthWithinArea_ComponentToCheckIfIsWithinInfo> ComponentsToCheckIfIsWithin;                       // 0x01B0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, ContainsInstancedReference, NativeAccessSpecifierPublic)
	float                                         ExtraExtentToApplyPaintOn;                         // 0x01C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AreaOfEffectWithFullColor;                         // 0x01C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FallOffStrength;                                   // 0x01C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVertexPaintWithinAreaFallOffType             FalloffType;                                       // 0x01CC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexPainthWithinAreaStruct) == 0x0001D0, "Wrong size on FVertexPainthWithinAreaStruct");
static_assert(offsetof(FVertexPainthWithinAreaStruct, ComponentsToCheckIfIsWithin) == 0x0001B0, "Member 'FVertexPainthWithinAreaStruct::ComponentsToCheckIfIsWithin' has a wrong offset!");
static_assert(offsetof(FVertexPainthWithinAreaStruct, ExtraExtentToApplyPaintOn) == 0x0001C0, "Member 'FVertexPainthWithinAreaStruct::ExtraExtentToApplyPaintOn' has a wrong offset!");
static_assert(offsetof(FVertexPainthWithinAreaStruct, AreaOfEffectWithFullColor) == 0x0001C4, "Member 'FVertexPainthWithinAreaStruct::AreaOfEffectWithFullColor' has a wrong offset!");
static_assert(offsetof(FVertexPainthWithinAreaStruct, FallOffStrength) == 0x0001C8, "Member 'FVertexPainthWithinAreaStruct::FallOffStrength' has a wrong offset!");
static_assert(offsetof(FVertexPainthWithinAreaStruct, FalloffType) == 0x0001CC, "Member 'FVertexPainthWithinAreaStruct::FalloffType' has a wrong offset!");
...
{
public:
	struct FVertexDetectPaintOnEntireMeshRandomizeSettingsStruct PaintOnRandomVerticesSettings;                     // 0x01B0(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexPaintOnEntireMeshStruct) == 0x0001C0, "Wrong size on FVertexPaintOnEntireMeshStruct");
static_assert(offsetof(FVertexPaintOnEntireMeshStruct, PaintOnRandomVerticesSettings) == 0x0001B0, "Member 'FVertexPaintOnEntireMeshStruct::PaintOnRandomVerticesSettings' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClosestVertexNormalStruct) == 0x000008, "Wrong alignment on FVertexDetectClosestVertexNormalStruct");
static_assert(sizeof(FVertexDetectClosestVertexNormalStruct) == 0x000030, "Wrong size on FVertexDetectClosestVertexNormalStruct");
...
static_assert(offsetof(FVertexDetectClosestVertexNormalStruct, ClosestVertexNormalLocal) == 0x000018, "Member 'FVertexDetectClosestVertexNormalStruct::ClosestVertexNormalLocal' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClosestVertexPositionStruct) == 0x000008, "Wrong alignment on FVertexDetectClosestVertexPositionStruct");
static_assert(sizeof(FVertexDetectClosestVertexPositionStruct) == 0x000030, "Wrong size on FVertexDetectClosestVertexPositionStruct");
...
static_assert(offsetof(FVertexDetectClosestVertexPositionStruct, ClosestVertexPositionActorLocal) == 0x000018, "Member 'FVertexDetectClosestVertexPositionStruct::ClosestVertexPositionActorLocal' has a wrong offset!");
...
public:
	...
	struct FVertexDetectClosestVertexPositionStruct ClosestVertexPositionInfo;                         // 0x0018(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClosestVertexNormalStruct ClosestVertexNormalInfo;                           // 0x0048(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexDetectClosestVertexGeneralInfoStruct) == 0x000090, "Wrong size on FVertexDetectClosestVertexGeneralInfoStruct");
...
static_assert(offsetof(FVertexDetectClosestVertexGeneralInfoStruct, ClosestVertexNormalInfo) == 0x000048, "Member 'FVertexDetectClosestVertexGeneralInfoStruct::ClosestVertexNormalInfo' has a wrong offset!");
static_assert(offsetof(FVertexDetectClosestVertexGeneralInfoStruct, ClosestVertexMaterial) == 0x000078, "Member 'FVertexDetectClosestVertexGeneralInfoStruct::ClosestVertexMaterial' has a wrong offset!");
static_assert(offsetof(FVertexDetectClosestVertexGeneralInfoStruct, ClosestVertexUVAtEachUVChannel) == 0x000080, "Member 'FVertexDetectClosestVertexGeneralInfoStruct::ClosestVertexUVAtEachUVChannel' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectClosestVertexGeneralInfoStruct ClosestVertexGeneralInfo;                          // 0x0008(0x0090)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	struct FVertexDetectPhysicsSurfaceDataStruct  ClosestVertexPhysicalSurfaceInfo;                  // 0x0098(0x0108)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexDetectClosestVertexDataResultStruct) == 0x0001A0, "Wrong size on FVertexDetectClosestVertexDataResultStruct");
...
static_assert(offsetof(FVertexDetectClosestVertexDataResultStruct, ClosestVertexPhysicalSurfaceInfo) == 0x000098, "Member 'FVertexDetectClosestVertexDataResultStruct::ClosestVertexPhysicalSurfaceInfo' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UObject>                 MeshSource;                                        // 0x0000(0x0030)(Edit, BlueprintVisible, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPrimitiveComponent>     MeshComp;                                          // 0x0030(0x0030)(Edit, BlueprintVisible, ExportObject, EditConst, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVertexDetectMeshDataPerLODStruct> MeshDataPerLOD;                                    // 0x0060(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectMeshDataStruct) == 0x000008, "Wrong alignment on FVertexDetectMeshDataStruct");
static_assert(sizeof(FVertexDetectMeshDataStruct) == 0x000070, "Wrong size on FVertexDetectMeshDataStruct");
...
static_assert(offsetof(FVertexDetectMeshDataStruct, MeshComp) == 0x000030, "Member 'FVertexDetectMeshDataStruct::MeshComp' has a wrong offset!");
static_assert(offsetof(FVertexDetectMeshDataStruct, MeshDataPerLOD) == 0x000060, "Member 'FVertexDetectMeshDataStruct::MeshDataPerLOD' has a wrong offset!");
...
public:
	...
	struct FVector                                WorldSpaceLocationWeEstimatedTheColorAt;           // 0x0120(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexDetectEstimatedColorAtHitLocationResultStruct) == 0x000138, "Wrong size on FVertexDetectEstimatedColorAtHitLocationResultStruct");
...
// ScriptStruct VertexPaintDetectionPlugin.VertexDetectCompareMeshColorsToColorArrayResultStruct
// 0x0008 (0x0008 - 0x0000)
struct FVertexDetectCompareMeshColorsToColorArrayResultStruct final
{
public:
	bool                                          SuccessfullyComparedMeshColorsToColorArray;        // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FVertexDetectCompareMeshColorsToColorArrayResultStruct) == 0x000004, "Wrong alignment on FVertexDetectCompareMeshColorsToColorArrayResultStruct");
static_assert(sizeof(FVertexDetectCompareMeshColorsToColorArrayResultStruct) == 0x000008, "Wrong size on FVertexDetectCompareMeshColorsToColorArrayResultStruct");
static_assert(offsetof(FVertexDetectCompareMeshColorsToColorArrayResultStruct, SuccessfullyComparedMeshColorsToColorArray) == 0x000000, "Member 'FVertexDetectCompareMeshColorsToColorArrayResultStruct::SuccessfullyComparedMeshColorsToColorArray' has a wrong offset!");
static_assert(offsetof(FVertexDetectCompareMeshColorsToColorArrayResultStruct, MatchingPercent) == 0x000004, "Member 'FVertexDetectCompareMeshColorsToColorArrayResultStruct::MatchingPercent' has a wrong offset!");
...
public:
	...
	struct FVertexDetectCompareMeshColorsToColorArrayResultStruct CompareMeshColorsToColorArrayResult;               // 0x000C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectTaskResultInfo) == 0x000004, "Wrong alignment on FVertexDetectTaskResultInfo");
static_assert(sizeof(FVertexDetectTaskResultInfo) == 0x000014, "Wrong size on FVertexDetectTaskResultInfo");
...
static_assert(offsetof(FVertexDetectTaskResultInfo, CompareMeshColorsToColorArrayResult) == 0x00000C, "Member 'FVertexDetectTaskResultInfo::CompareMeshColorsToColorArrayResult' has a wrong offset!");
...
public:
	...
	int32                                         OptionalFaceIndexForStaticMeshComponents;          // 0x0050(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 RunTaskFor;                                        // 0x0058(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexDetectAndPaintFundementalsStruct) == 0x000068, "Wrong size on FVertexDetectAndPaintFundementalsStruct");
...
static_assert(offsetof(FVertexDetectAndPaintFundementalsStruct, HitLocationInComponentSpace) == 0x000018, "Member 'FVertexDetectAndPaintFundementalsStruct::HitLocationInComponentSpace' has a wrong offset!");
static_assert(offsetof(FVertexDetectAndPaintFundementalsStruct, HitNormal) == 0x000030, "Member 'FVertexDetectAndPaintFundementalsStruct::HitNormal' has a wrong offset!");
static_assert(offsetof(FVertexDetectAndPaintFundementalsStruct, HitBone) == 0x000048, "Member 'FVertexDetectAndPaintFundementalsStruct::HitBone' has a wrong offset!");
static_assert(offsetof(FVertexDetectAndPaintFundementalsStruct, OptionalFaceIndexForStaticMeshComponents) == 0x000050, "Member 'FVertexDetectAndPaintFundementalsStruct::OptionalFaceIndexForStaticMeshComponents' has a wrong offset!");
static_assert(offsetof(FVertexDetectAndPaintFundementalsStruct, RunTaskFor) == 0x000058, "Member 'FVertexDetectAndPaintFundementalsStruct::RunTaskFor' has a wrong offset!");
...
{
public:
	struct FVertexDetectGetAverageColorStruct     GetAverageColorInAreaSettings;                     // 0x0050(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectAndPaintFundementalsStruct HitFundementals;                                   // 0x0058(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectEstimatedColorAtHitLocationStruct GetEstimatedColorAtHitLocationSettings;            // 0x00C0(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectInfoStruct) == 0x000008, "Wrong alignment on FVertexDetectInfoStruct");
static_assert(sizeof(FVertexDetectInfoStruct) == 0x0000C8, "Wrong size on FVertexDetectInfoStruct");
static_assert(offsetof(FVertexDetectInfoStruct, GetAverageColorInAreaSettings) == 0x000050, "Member 'FVertexDetectInfoStruct::GetAverageColorInAreaSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectInfoStruct, HitFundementals) == 0x000058, "Member 'FVertexDetectInfoStruct::HitFundementals' has a wrong offset!");
static_assert(offsetof(FVertexDetectInfoStruct, GetEstimatedColorAtHitLocationSettings) == 0x0000C0, "Member 'FVertexDetectInfoStruct::GetEstimatedColorAtHitLocationSettings' has a wrong offset!");
...
static_assert(sizeof(FVertexDetectGetColorsOnlyStruct) == 0x000050, "Wrong size on FVertexDetectGetColorsOnlyStruct");
...
public:
	...
	struct FVertexDetectAndPaintFundementalsStruct DetectHitFundementals;                             // 0x0010(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectWhenPaintingSettings) == 0x000008, "Wrong alignment on FVertexDetectWhenPaintingSettings");
static_assert(sizeof(FVertexDetectWhenPaintingSettings) == 0x000078, "Wrong size on FVertexDetectWhenPaintingSettings");
...
{
public:
	struct FVertexDetectAndPaintFundementalsStruct HitFundementals;                                   // 0x01B0(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectPaintAtLocationAreaSettings PaintAtAreaSettings;                               // 0x0218(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectEstimatedColorAtHitLocationStruct GetEstimatedColorAtHitLocationSettings;            // 0x022C(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_234[0x4];                                      // 0x0234(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectWhenPaintingSettings      Detection;                                         // 0x0238(0x0078)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexPaintAtLocationStruct) == 0x000008, "Wrong alignment on FVertexPaintAtLocationStruct");
static_assert(sizeof(FVertexPaintAtLocationStruct) == 0x0002B0, "Wrong size on FVertexPaintAtLocationStruct");
static_assert(offsetof(FVertexPaintAtLocationStruct, HitFundementals) == 0x0001B0, "Member 'FVertexPaintAtLocationStruct::HitFundementals' has a wrong offset!");
static_assert(offsetof(FVertexPaintAtLocationStruct, PaintAtAreaSettings) == 0x000218, "Member 'FVertexPaintAtLocationStruct::PaintAtAreaSettings' has a wrong offset!");
static_assert(offsetof(FVertexPaintAtLocationStruct, GetEstimatedColorAtHitLocationSettings) == 0x00022C, "Member 'FVertexPaintAtLocationStruct::GetEstimatedColorAtHitLocationSettings' has a wrong offset!");
static_assert(offsetof(FVertexPaintAtLocationStruct, Detection) == 0x000238, "Member 'FVertexPaintAtLocationStruct::Detection' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           ColorSnippetTag;                                   // 0x0070(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           RandomizeAnyColorSnippetTagUnderThisCategory;      // 0x0078(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ColorSnippetID;                                    // 0x0080(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UVertexPaintColorSnippetDataAsset*      ColorSnippetDataAssetSnippetIsStoredIn;            // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexPaintColorSnippetStruct) == 0x000008, "Wrong alignment on FVertexPaintColorSnippetStruct");
static_assert(sizeof(FVertexPaintColorSnippetStruct) == 0x000098, "Wrong size on FVertexPaintColorSnippetStruct");
static_assert(offsetof(FVertexPaintColorSnippetStruct, ColorSnippetTag) == 0x000070, "Member 'FVertexPaintColorSnippetStruct::ColorSnippetTag' has a wrong offset!");
static_assert(offsetof(FVertexPaintColorSnippetStruct, RandomizeAnyColorSnippetTagUnderThisCategory) == 0x000078, "Member 'FVertexPaintColorSnippetStruct::RandomizeAnyColorSnippetTagUnderThisCategory' has a wrong offset!");
static_assert(offsetof(FVertexPaintColorSnippetStruct, ColorSnippetID) == 0x000080, "Member 'FVertexPaintColorSnippetStruct::ColorSnippetID' has a wrong offset!");
static_assert(offsetof(FVertexPaintColorSnippetStruct, ColorSnippetDataAssetSnippetIsStoredIn) == 0x000090, "Member 'FVertexPaintColorSnippetStruct::ColorSnippetDataAssetSnippetIsStoredIn' has a wrong offset!");
...
{
public:
	class AActor*                                 PassThrough_Actor;                                 // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PassThrough_PrimitiveComponent;                    // 0x0008(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                PassThrough_Vector1;                               // 0x0028(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PassThrough_Vector2;                               // 0x0040(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PassThrough_Vector3;                               // 0x0058(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PassThrough_Vector4;                               // 0x0070(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               PassThrough_Rotator1;                              // 0x0088(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               PassThrough_Rotator2;                              // 0x00A0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x8];                                       // 0x00B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             PassThrough_Transform;                             // 0x00C0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PassThrough_String1;                               // 0x0120(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PassThrough_String2;                               // 0x0130(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PassThrough_Name;                                  // 0x0140(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPhysicalSurface                              PassThrough_PhysicsSurface1;                       // 0x0148(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPhysicalSurface                              PassThrough_PhysicsSurface2;                       // 0x0149(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14A[0x6];                                      // 0x014A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicalMaterial*                      PassThrough_PhysicalMaterial1;                     // 0x0150(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             PassThrough_ObjectCollisionChannel;                // 0x0158(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EObjectTypeQuery                              PassThrough_ObjectType;                            // 0x0159(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15A[0x6];                                      // 0x015A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                PassThrough_UObject1;                              // 0x0160(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                PassThrough_UObject2;                              // 0x0168(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVertexDetectMeshDataStruct            PassThrough_MeshVertexData;                        // 0x0170(0x0070)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexDetectClosestVertexDataResultStruct PassThrough_ClosestVertexInfo;                     // 0x01E0(0x01A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectEstimatedColorAtHitLocationResultStruct PassThrough_EstimatedColorAtHitLocationInfo;       // 0x0380(0x0138)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectAvarageColorInAreaInfo    PassThrough_AvarageColorInAreaInfo;                // 0x04B8(0x0118)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectAmountOfPaintedColorsOfEachChannel PassThrough_AmountOfPaintedColorsOfEachChannel;    // 0x05D0(0x0034)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_604[0x4];                                      // 0x0604(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectVertexColorsOnEachBone    PassThrough_vertexColorsOnEachBone;                // 0x0608(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVertexDetectTaskResultInfo            PassThrough_TaskResultInfo;                        // 0x0660(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_674[0x4];                                      // 0x0674(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectInfoStruct                PassThrough_DetectedMeshWithSettings;              // 0x0678(0x00C8)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexDetectGetColorsOnlyStruct       GotAllVertexColorsWithSettings;                    // 0x0740(0x0050)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexPaintAtLocationStruct           MeshPaintedWithSettings;                           // 0x0790(0x02B0)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexPainthWithinAreaStruct          AreaWithinMeshPaintedWithSettings;                 // 0x0A40(0x01D0)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexPaintOnEntireMeshStruct         EntireMeshPaintedWithSettings;                     // 0x0C10(0x01C0)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexPaintColorSnippetStruct         PaintColorSnippetWithSettings;                     // 0x0DD0(0x0098)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FVertexPaintStruct                     SetMeshComponentVertexColorSettings;               // 0x0E68(0x0070)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexDetectAdditionalDataToPassThrough) == 0x000EE0, "Wrong size on FVertexDetectAdditionalDataToPassThrough");
...
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Vector1) == 0x000028, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Vector1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Vector2) == 0x000040, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Vector2' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Vector3) == 0x000058, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Vector3' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Vector4) == 0x000070, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Vector4' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Rotator1) == 0x000088, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Rotator1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Rotator2) == 0x0000A0, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Rotator2' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Transform) == 0x0000C0, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Transform' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_String1) == 0x000120, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_String1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_String2) == 0x000130, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_String2' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_Name) == 0x000140, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_Name' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_PhysicsSurface1) == 0x000148, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_PhysicsSurface1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_PhysicsSurface2) == 0x000149, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_PhysicsSurface2' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_PhysicalMaterial1) == 0x000150, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_PhysicalMaterial1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_ObjectCollisionChannel) == 0x000158, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_ObjectCollisionChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_ObjectType) == 0x000159, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_ObjectType' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_UObject1) == 0x000160, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_UObject1' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_UObject2) == 0x000168, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_UObject2' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_MeshVertexData) == 0x000170, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_MeshVertexData' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_ClosestVertexInfo) == 0x0001E0, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_ClosestVertexInfo' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_EstimatedColorAtHitLocationInfo) == 0x000380, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_EstimatedColorAtHitLocationInfo' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_AvarageColorInAreaInfo) == 0x0004B8, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_AvarageColorInAreaInfo' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_AmountOfPaintedColorsOfEachChannel) == 0x0005D0, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_AmountOfPaintedColorsOfEachChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_vertexColorsOnEachBone) == 0x000608, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_vertexColorsOnEachBone' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_TaskResultInfo) == 0x000660, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_TaskResultInfo' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PassThrough_DetectedMeshWithSettings) == 0x000678, "Member 'FVertexDetectAdditionalDataToPassThrough::PassThrough_DetectedMeshWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, GotAllVertexColorsWithSettings) == 0x000740, "Member 'FVertexDetectAdditionalDataToPassThrough::GotAllVertexColorsWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, MeshPaintedWithSettings) == 0x000790, "Member 'FVertexDetectAdditionalDataToPassThrough::MeshPaintedWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, AreaWithinMeshPaintedWithSettings) == 0x000A40, "Member 'FVertexDetectAdditionalDataToPassThrough::AreaWithinMeshPaintedWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, EntireMeshPaintedWithSettings) == 0x000C10, "Member 'FVertexDetectAdditionalDataToPassThrough::EntireMeshPaintedWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, PaintColorSnippetWithSettings) == 0x000DD0, "Member 'FVertexDetectAdditionalDataToPassThrough::PaintColorSnippetWithSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectAdditionalDataToPassThrough, SetMeshComponentVertexColorSettings) == 0x000E68, "Member 'FVertexDetectAdditionalDataToPassThrough::SetMeshComponentVertexColorSettings' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UObject>                 ObjectColorSnippetBelongsTo;                       // 0x0000(0x0030)(Edit, BlueprintVisible, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVertexDetectMeshDataPerLODStruct> ColorSnippetDataPerLOD;                            // 0x0030(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FVertexDetectSerializedColorsPerLODStruct> ColorSnippetPerLODAsRapidJSon;                     // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexDetectColorSnippetDataStruct) == 0x000050, "Wrong size on FVertexDetectColorSnippetDataStruct");
...
static_assert(offsetof(FVertexDetectColorSnippetDataStruct, ColorSnippetDataPerLOD) == 0x000030, "Member 'FVertexDetectColorSnippetDataStruct::ColorSnippetDataPerLOD' has a wrong offset!");
static_assert(offsetof(FVertexDetectColorSnippetDataStruct, ColorSnippetPerLODAsRapidJSon) == 0x000040, "Member 'FVertexDetectColorSnippetDataStruct::ColorSnippetPerLODAsRapidJSon' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UMaterialInterface>      AssociatedMaterial;                                // 0x0000(0x0030)(Edit, BlueprintVisible, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<EPhysicalSurface>                      PhysicsSurfacesThatCanBlend;                       // 0x0030(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	float                                         MinAmountOnEachSurfaceToBeAbleToBlend;             // 0x0040(0x0004)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPhysicalSurface                              PhysicsSurfaceToResultIn;                          // 0x0044(0x0001)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexPaintPhysicsSurfaceBlendingSettings) == 0x000048, "Wrong size on FVertexPaintPhysicsSurfaceBlendingSettings");
...
static_assert(offsetof(FVertexPaintPhysicsSurfaceBlendingSettings, PhysicsSurfacesThatCanBlend) == 0x000030, "Member 'FVertexPaintPhysicsSurfaceBlendingSettings::PhysicsSurfacesThatCanBlend' has a wrong offset!");
static_assert(offsetof(FVertexPaintPhysicsSurfaceBlendingSettings, MinAmountOnEachSurfaceToBeAbleToBlend) == 0x000040, "Member 'FVertexPaintPhysicsSurfaceBlendingSettings::MinAmountOnEachSurfaceToBeAbleToBlend' has a wrong offset!");
static_assert(offsetof(FVertexPaintPhysicsSurfaceBlendingSettings, PhysicsSurfaceToResultIn) == 0x000044, "Member 'FVertexPaintPhysicsSurfaceBlendingSettings::PhysicsSurfaceToResultIn' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClothPhysicsMaterialSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsMaterialSettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsMaterialSettingsStruct) == 0x000030, "Wrong size on FVertexDetectClothPhysicsMaterialSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothPhysicsMaterialSettingsStruct, Material_BendingStiffness) == 0x000010, "Member 'FVertexDetectClothPhysicsMaterialSettingsStruct::Material_BendingStiffness' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsMaterialSettingsStruct, Material_AreaStiffness) == 0x000020, "Member 'FVertexDetectClothPhysicsMaterialSettingsStruct::Material_AreaStiffness' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClothPhysicsWindSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsWindSettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsWindSettingsStruct) == 0x000040, "Wrong size on FVertexDetectClothPhysicsWindSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothPhysicsWindSettingsStruct, SetWind_lift) == 0x000010, "Member 'FVertexDetectClothPhysicsWindSettingsStruct::SetWind_lift' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsWindSettingsStruct, SetWind_airDensity) == 0x000020, "Member 'FVertexDetectClothPhysicsWindSettingsStruct::SetWind_airDensity' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsWindSettingsStruct, SetWind_windVelocity) == 0x000028, "Member 'FVertexDetectClothPhysicsWindSettingsStruct::SetWind_windVelocity' has a wrong offset!");
...
// 0x1E80 (0x1E80 - 0x0000)
struct alignas(0x10) FCalculateColorsInfo final
{
public:
	uint8                                         Pad_0[0x1E80];                                     // 0x0000(0x1E80)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCalculateColorsInfo) == 0x000010, "Wrong alignment on FCalculateColorsInfo");
static_assert(sizeof(FCalculateColorsInfo) == 0x001E80, "Wrong size on FCalculateColorsInfo");
...
static_assert(alignof(FVertexDetectClothPhysicsGravitySettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsGravitySettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsGravitySettingsStruct) == 0x000020, "Wrong size on FVertexDetectClothPhysicsGravitySettingsStruct");
...
{
public:
	class FString                                 SerializedColorDataAtLOD0;                         // 0x0070(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PrintLogsToScreen;                                 // 0x0080(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PrintLogsToScreen_Duration;                        // 0x0084(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PrintLogsToOutputLog;                              // 0x0088(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UVertexPaintDetectionComponent*         OptionalCallbackComponent;                         // 0x0090(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString) == 0x000098, "Wrong size on FVertexPaintSetMeshComponentVertexColorsUsingSerializedString");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString, SerializedColorDataAtLOD0) == 0x000070, "Member 'FVertexPaintSetMeshComponentVertexColorsUsingSerializedString::SerializedColorDataAtLOD0' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString, PrintLogsToScreen) == 0x000080, "Member 'FVertexPaintSetMeshComponentVertexColorsUsingSerializedString::PrintLogsToScreen' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString, PrintLogsToScreen_Duration) == 0x000084, "Member 'FVertexPaintSetMeshComponentVertexColorsUsingSerializedString::PrintLogsToScreen_Duration' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString, PrintLogsToOutputLog) == 0x000088, "Member 'FVertexPaintSetMeshComponentVertexColorsUsingSerializedString::PrintLogsToOutputLog' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColorsUsingSerializedString, OptionalCallbackComponent) == 0x000090, "Member 'FVertexPaintSetMeshComponentVertexColorsUsingSerializedString::OptionalCallbackComponent' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClothPhysicsAnimDriveSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsAnimDriveSettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsAnimDriveSettingsStruct) == 0x000020, "Wrong size on FVertexDetectClothPhysicsAnimDriveSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothPhysicsAnimDriveSettingsStruct, SetAnimDrive_Damping) == 0x000010, "Member 'FVertexDetectClothPhysicsAnimDriveSettingsStruct::SetAnimDrive_Damping' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct) == 0x000020, "Wrong size on FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct, LongRangeAttachment_TetherScale) == 0x000010, "Member 'FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct::LongRangeAttachment_TetherScale' has a wrong offset!");
...
static_assert(alignof(FVertexDetectClothPhysicsVelocityScaleSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsVelocityScaleSettingsStruct");
static_assert(sizeof(FVertexDetectClothPhysicsVelocityScaleSettingsStruct) == 0x000020, "Wrong size on FVertexDetectClothPhysicsVelocityScaleSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothPhysicsVelocityScaleSettingsStruct, PhysicVelocityScale_AngularVelocityScale) == 0x000018, "Member 'FVertexDetectClothPhysicsVelocityScaleSettingsStruct::PhysicVelocityScale_AngularVelocityScale' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsVelocityScaleSettingsStruct, PhysicsVelocityScale_FictitiousAngularVelocityScale) == 0x00001C, "Member 'FVertexDetectClothPhysicsVelocityScaleSettingsStruct::PhysicsVelocityScale_FictitiousAngularVelocityScale' has a wrong offset!");

// ScriptStruct VertexPaintDetectionPlugin.VertexDetectClothPhysicsSetAirPressureStruct
// 0x0010 (0x0010 - 0x0000)
struct FVertexDetectClothPhysicsSetAirPressureStruct final
{
public:
...
static_assert(alignof(FVertexDetectClothPhysicsSetAirPressureStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsSetAirPressureStruct");
static_assert(sizeof(FVertexDetectClothPhysicsSetAirPressureStruct) == 0x000010, "Wrong size on FVertexDetectClothPhysicsSetAirPressureStruct");
static_assert(offsetof(FVertexDetectClothPhysicsSetAirPressureStruct, SetPressure_Pressure) == 0x000000, "Member 'FVertexDetectClothPhysicsSetAirPressureStruct::SetPressure_Pressure' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectClothPhysicsGravitySettingsStruct ClothGravitySettingsWithNoColorPaintedAtChannel;   // 0x0010(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsGravitySettingsStruct ClothGravitySettingsWithFullColorPaintedAtChannel; // 0x0030(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsWindSettingsStruct ClothWindSettingsWithNoColorPaintedAtChannel;      // 0x0058(0x0040)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsWindSettingsStruct ClothWindSettingsWithFullColorPaintedAtChannel;    // 0x0098(0x0040)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsAnimDriveSettingsStruct ClothAnimDriveSettingsWithNoColorPaintedAtChannel; // 0x00E0(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsAnimDriveSettingsStruct ClothAnimDriveSettingsWithFullColorPaintedAtChannel; // 0x0100(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsCollisionSettingsStruct ClothCollisionSettingsWithNoColorPaintedAtChannel; // 0x0124(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsCollisionSettingsStruct ClothCollisionSettingsWithFullColorPaintedAtChannel; // 0x0134(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct ClothLongRangeAttachmentSettingsWithNoColorPaintedAtChannel; // 0x0148(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct ClothLongRangeAttachmentSettingsWithFullColorPaintedAtChannel; // 0x0168(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsMaterialSettingsStruct ClothMaterialSettingsWithNoColorPaintedAtChannel;  // 0x0190(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsMaterialSettingsStruct ClothMaterialSettingsWithFullColorPaintedAtChannel; // 0x01C0(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsVelocityScaleSettingsStruct ClothPhysicsVelocityScaleSettingsWithNoColorPaintedAtChannel; // 0x01F8(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsVelocityScaleSettingsStruct ClothPhysicsVelocityScaleSettingsWithFullColorPaintedAtChannel; // 0x0218(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsSetAirPressureStruct ClothPhysicssAirPressureWithNoColorPaintedAtChannel; // 0x0240(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsSetAirPressureStruct ClothPhysicssAirPressureWithFullColorPaintedAtChannel; // 0x0250(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct) == 0x000008, "Wrong alignment on FVertexDetectClothPhysicsSettingsAtVertexColorStruct");
static_assert(sizeof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct) == 0x000260, "Wrong size on FVertexDetectClothPhysicsSettingsAtVertexColorStruct");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetDamping) == 0x000000, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetDamping' has a wrong offset!");
...
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothGravitySettingsWithFullColorPaintedAtChannel) == 0x000030, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothGravitySettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetWind) == 0x000050, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetWind' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothWindSettingsWithNoColorPaintedAtChannel) == 0x000058, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothWindSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothWindSettingsWithFullColorPaintedAtChannel) == 0x000098, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothWindSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetAnimDrive) == 0x0000D8, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetAnimDrive' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothAnimDriveSettingsWithNoColorPaintedAtChannel) == 0x0000E0, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothAnimDriveSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothAnimDriveSettingsWithFullColorPaintedAtChannel) == 0x000100, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothAnimDriveSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetCollision) == 0x000120, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetCollision' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothCollisionSettingsWithNoColorPaintedAtChannel) == 0x000124, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothCollisionSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothCollisionSettingsWithFullColorPaintedAtChannel) == 0x000134, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothCollisionSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetLongRangeAttachment) == 0x000144, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetLongRangeAttachment' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothLongRangeAttachmentSettingsWithNoColorPaintedAtChannel) == 0x000148, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothLongRangeAttachmentSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothLongRangeAttachmentSettingsWithFullColorPaintedAtChannel) == 0x000168, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothLongRangeAttachmentSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetMaterial) == 0x000188, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetMaterial' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothMaterialSettingsWithNoColorPaintedAtChannel) == 0x000190, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothMaterialSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothMaterialSettingsWithFullColorPaintedAtChannel) == 0x0001C0, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothMaterialSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetPhysicsVelocityScale) == 0x0001F0, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetPhysicsVelocityScale' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothPhysicsVelocityScaleSettingsWithNoColorPaintedAtChannel) == 0x0001F8, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothPhysicsVelocityScaleSettingsWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothPhysicsVelocityScaleSettingsWithFullColorPaintedAtChannel) == 0x000218, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothPhysicsVelocityScaleSettingsWithFullColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, SetAirPressure) == 0x000238, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::SetAirPressure' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothPhysicssAirPressureWithNoColorPaintedAtChannel) == 0x000240, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothPhysicssAirPressureWithNoColorPaintedAtChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothPhysicsSettingsAtVertexColorStruct, ClothPhysicssAirPressureWithFullColorPaintedAtChannel) == 0x000250, "Member 'FVertexDetectClothPhysicsSettingsAtVertexColorStruct::ClothPhysicssAirPressureWithFullColorPaintedAtChannel' has a wrong offset!");
...
{
public:
	struct FVertexDetectClothPhysicsSettingsAtVertexColorStruct ClothPhysicsSettingsAtRedChannel;                  // 0x0000(0x0260)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsSettingsAtVertexColorStruct ClothPhysicsSettingsAtGreenChannel;                // 0x0260(0x0260)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsSettingsAtVertexColorStruct ClothPhysicsSettingsAtBlueChannel;                 // 0x04C0(0x0260)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FVertexDetectClothPhysicsSettingsAtVertexColorStruct ClothPhysicsSettingsAtAlphaChannel;                // 0x0720(0x0260)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectClothSettingsStruct) == 0x000008, "Wrong alignment on FVertexDetectClothSettingsStruct");
static_assert(sizeof(FVertexDetectClothSettingsStruct) == 0x000980, "Wrong size on FVertexDetectClothSettingsStruct");
...
static_assert(offsetof(FVertexDetectClothSettingsStruct, ClothPhysicsSettingsAtGreenChannel) == 0x000260, "Member 'FVertexDetectClothSettingsStruct::ClothPhysicsSettingsAtGreenChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothSettingsStruct, ClothPhysicsSettingsAtBlueChannel) == 0x0004C0, "Member 'FVertexDetectClothSettingsStruct::ClothPhysicsSettingsAtBlueChannel' has a wrong offset!");
static_assert(offsetof(FVertexDetectClothSettingsStruct, ClothPhysicsSettingsAtAlphaChannel) == 0x000720, "Member 'FVertexDetectClothSettingsStruct::ClothPhysicsSettingsAtAlphaChannel' has a wrong offset!");
...
public:
	...
	struct FVertexDetectClothPhysicsGravitySettingsStruct ClothGravitySettings;                              // 0x0010(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsWindSettingsStruct ClothWindSettings;                                 // 0x0038(0x0040)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsAnimDriveSettingsStruct ClothAnimDriveSettings;                            // 0x0080(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsCollisionSettingsStruct ClothCollisionSettings;                            // 0x00A4(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsLongRangeAttachmentSettingsStruct ClothLongRangeAttachmentSettings;                  // 0x00B8(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVertexDetectClothPhysicsMaterialSettingsStruct ClothMaterialSettings;                             // 0x00E0(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsVelocityScaleSettingsStruct ClothPhysicsVelocityScaleSettings;                 // 0x0118(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVertexDetectClothPhysicsSetAirPressureStruct ClothPhysicssAirPressureSettings;                  // 0x0140(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVertexDetectChaosClothPhysicsSettings) == 0x000008, "Wrong alignment on FVertexDetectChaosClothPhysicsSettings");
static_assert(sizeof(FVertexDetectChaosClothPhysicsSettings) == 0x000150, "Wrong size on FVertexDetectChaosClothPhysicsSettings");
...
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothGravitySettings) == 0x000010, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothGravitySettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetWind) == 0x000030, "Member 'FVertexDetectChaosClothPhysicsSettings::SetWind' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothWindSettings) == 0x000038, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothWindSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetAnimDrive) == 0x000078, "Member 'FVertexDetectChaosClothPhysicsSettings::SetAnimDrive' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothAnimDriveSettings) == 0x000080, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothAnimDriveSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetCollision) == 0x0000A0, "Member 'FVertexDetectChaosClothPhysicsSettings::SetCollision' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothCollisionSettings) == 0x0000A4, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothCollisionSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetLongRangeAttachment) == 0x0000B4, "Member 'FVertexDetectChaosClothPhysicsSettings::SetLongRangeAttachment' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothLongRangeAttachmentSettings) == 0x0000B8, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothLongRangeAttachmentSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetMaterial) == 0x0000D8, "Member 'FVertexDetectChaosClothPhysicsSettings::SetMaterial' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothMaterialSettings) == 0x0000E0, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothMaterialSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetPhysicsVelocityScale) == 0x000110, "Member 'FVertexDetectChaosClothPhysicsSettings::SetPhysicsVelocityScale' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothPhysicsVelocityScaleSettings) == 0x000118, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothPhysicsVelocityScaleSettings' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, SetAirPressure) == 0x000138, "Member 'FVertexDetectChaosClothPhysicsSettings::SetAirPressure' has a wrong offset!");
static_assert(offsetof(FVertexDetectChaosClothPhysicsSettings, ClothPhysicssAirPressureSettings) == 0x000140, "Member 'FVertexDetectChaosClothPhysicsSettings::ClothPhysicssAirPressureSettings' has a wrong offset!");
...
{
public:
	TArray<struct FColor>                         VertexColorsAtLOD0ToSet;                           // 0x0070(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          PrintLogsToScreen;                                 // 0x0080(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PrintLogsToScreen_Duration;                        // 0x0084(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PrintLogsToOutputLog;                              // 0x0088(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVertexPaintSetMeshComponentVertexColors) == 0x000098, "Wrong size on FVertexPaintSetMeshComponentVertexColors");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColors, VertexColorsAtLOD0ToSet) == 0x000070, "Member 'FVertexPaintSetMeshComponentVertexColors::VertexColorsAtLOD0ToSet' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColors, PrintLogsToScreen) == 0x000080, "Member 'FVertexPaintSetMeshComponentVertexColors::PrintLogsToScreen' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColors, PrintLogsToScreen_Duration) == 0x000084, "Member 'FVertexPaintSetMeshComponentVertexColors::PrintLogsToScreen_Duration' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColors, PrintLogsToOutputLog) == 0x000088, "Member 'FVertexPaintSetMeshComponentVertexColors::PrintLogsToOutputLog' has a wrong offset!");
static_assert(offsetof(FVertexPaintSetMeshComponentVertexColors, OptionalCallbackComponent) == 0x000090, "Member 'FVertexPaintSetMeshComponentVertexColors::OptionalCallbackComponent' has a wrong offset!");
