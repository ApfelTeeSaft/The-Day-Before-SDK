...
static_assert(sizeof(RigHierarchy_FindControl_ForBlueprintOnly) == 0x000970, "Wrong size on RigHierarchy_FindControl_ForBlueprintOnly");
...
public:
	...
	uint8                                         Pad_971[0xF];                                      // 0x0971(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(ControlRig_OnControlSelectedBP__DelegateSignature) == 0x000980, "Wrong size on ControlRig_OnControlSelectedBP__DelegateSignature");
...
static_assert(offsetof(ControlRig_OnControlSelectedBP__DelegateSignature, bSelected) == 0x000970, "Member 'ControlRig_OnControlSelectedBP__DelegateSignature::bSelected' has a wrong offset!");
