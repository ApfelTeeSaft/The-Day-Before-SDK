...
{
public:
	TArray<TSubclassOf<class UARComponent>>       ARComponentClasses;                                // 0x0290(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UPassthroughMaterialUpdateComponent*    PassthroughUpdateComponent;                        // 0x02A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AARPassthroughManager) == 0x0002A8, "Wrong size on AARPassthroughManager");
static_assert(offsetof(AARPassthroughManager, ARComponentClasses) == 0x000290, "Member 'AARPassthroughManager::ARComponentClasses' has a wrong offset!");
static_assert(offsetof(AARPassthroughManager, PassthroughUpdateComponent) == 0x0002A0, "Member 'AARPassthroughManager::PassthroughUpdateComponent' has a wrong offset!");
