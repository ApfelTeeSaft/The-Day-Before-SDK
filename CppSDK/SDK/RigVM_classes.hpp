...
static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x000260, "Wrong size on URigVMMemoryStorageGeneratorClass");
...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x0003A0, "Wrong size on URigVMBlueprintGeneratedClass");
static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x000378, "Member 'URigVMBlueprintGeneratedClass::GraphFunctionStore' has a wrong offset!");
