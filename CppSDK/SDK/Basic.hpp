...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07CCDA10;
	constexpr int32 AppendString      = 0x02273700;
	constexpr int32 GNames            = 0x07C27980;
	constexpr int32 GWorld            = 0x07E249D0;
	constexpr int32 ProcessEvent      = 0x024077B0;
