...
{
public:
	double                                        Param_Fuzz;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BP_MotionBlurCage_C_SetFuzz, Param_Fuzz) == 0x000000, "Member 'BP_MotionBlurCage_C_SetFuzz::Param_Fuzz' has a wrong offset!");
...
{
public:
	double                                        Param_Strength;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BP_MotionBlurCage_C_SetStrength, Param_Strength) == 0x000000, "Member 'BP_MotionBlurCage_C_SetStrength::Param_Strength' has a wrong offset!");
