...
{
public:
	bool                                          ClothOverlapTracingEnabled;                        // 0x02A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A1[0x3];                                      // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ClothVertexTraceRadius;                            // 0x02A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ClothVertexTraceIntervall;                         // 0x02A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DebugClothSphereTraces;                            // 0x02AC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2AD[0x3];                                      // 0x02AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class USkeletalMeshComponent*                 ParentSkeletalMeshComponent;                       // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UClothingAssetBase*>             ParentSkeletalMeshComponentClothingAssets;         // 0x02B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<EObjectTypeQuery>                      ClothObjectsToSphereTrace;                         // 0x02C8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TMap<class AActor*, struct FVertexPaintClothOverlapComponentsStruct> ClothOverlappingActorsAndComponent;                // 0x02D8(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class UClothingAssetBase*, struct FTransform> ClothBoneTransformsInComponentSpaceTemp;           // 0x0328(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class UClothingAssetBase*, struct FQuat> ClothBoneQuaternionsInComponentSpaceTemp;          // 0x0378(0x0050)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVertexPaintClothOverlapComponent) == 0x0003D0, "Wrong size on UVertexPaintClothOverlapComponent");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothOverlapTracingEnabled) == 0x0002A0, "Member 'UVertexPaintClothOverlapComponent::ClothOverlapTracingEnabled' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothVertexTraceRadius) == 0x0002A4, "Member 'UVertexPaintClothOverlapComponent::ClothVertexTraceRadius' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothVertexTraceIntervall) == 0x0002A8, "Member 'UVertexPaintClothOverlapComponent::ClothVertexTraceIntervall' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, DebugClothSphereTraces) == 0x0002AC, "Member 'UVertexPaintClothOverlapComponent::DebugClothSphereTraces' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ParentSkeletalMeshComponent) == 0x0002B0, "Member 'UVertexPaintClothOverlapComponent::ParentSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ParentSkeletalMeshComponentClothingAssets) == 0x0002B8, "Member 'UVertexPaintClothOverlapComponent::ParentSkeletalMeshComponentClothingAssets' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothObjectsToSphereTrace) == 0x0002C8, "Member 'UVertexPaintClothOverlapComponent::ClothObjectsToSphereTrace' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothOverlappingActorsAndComponent) == 0x0002D8, "Member 'UVertexPaintClothOverlapComponent::ClothOverlappingActorsAndComponent' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothBoneTransformsInComponentSpaceTemp) == 0x000328, "Member 'UVertexPaintClothOverlapComponent::ClothBoneTransformsInComponentSpaceTemp' has a wrong offset!");
static_assert(offsetof(UVertexPaintClothOverlapComponent, ClothBoneQuaternionsInComponentSpaceTemp) == 0x000378, "Member 'UVertexPaintClothOverlapComponent::ClothBoneQuaternionsInComponentSpaceTemp' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             GetClosestVertexDataDelegate;                      // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             GetAllVertexColorsOnlyDelegate;                    // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsPaintedAtLocationDelegate;             // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsPaintedMeshWithinAreaDelegate;         // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsPaintedEntireMeshDelegate;             // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsPaintColorSnippetDelegate;             // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsSetMeshColorsDelegate;                 // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexColorsSetMeshColorsUsingSerializedStringDelegate; // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	bool                                          AtGameThread_drawVertexPositionDebugPoint;         // 0x0129(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AtGameThread_drawVertexNormalDebugArrow;           // 0x012A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AtGameThread_drawVertexPositionDebugPointOnVertexThatGotPaintApplied; // 0x012B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AtGameThread_drawClothVertexPositionDebugPoint;    // 0x012C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12D[0x3];                                      // 0x012D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AtGameThread_DrawVertexPointsDuration;             // 0x0130(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AtGameThread_DrawPaintConditionsDebugSymbols;      // 0x0134(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_135[0x3];                                      // 0x0135(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AtGameThread_DrawPaintConditionsDebugSymbolsDuration; // 0x0138(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawGetClosestVertexDataDebugSymbols;              // 0x013C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DrawGetClosestVertexDataDebugSymbolsDuration;      // 0x0140(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawGetEstimatedColorAtHitLocationDebugSymbols;    // 0x0144(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_145[0x3];                                      // 0x0145(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DrawGetEstimatedColorAtHitLocationDebugSymbolsDuration; // 0x0148(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawPaintWithinAreaDebugSymbols;                   // 0x014C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14D[0x3];                                      // 0x014D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DrawPaintWithinAreaDebugSymbolsDuration;           // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_154[0x54];                                     // 0x0154(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	class UVertexPaintDetectionGISubSystem*       VertexPaintGameInstanceSubsystem_Global;           // 0x01A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B0[0x20];                                     // 0x01B0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void GetCurrentTasksInitiatedByComponent(int32* TotalAmountOfTasks, int32* AmountOfGetClosestVertexDataTasks, int32* AmountOfGetAllVertexColorsOnlyTasks, int32* AmountOfPaintAtLocationTasks, int32* AmountOfPaintWithinAreaTasks, int32* AmountOfPaintEntireMeshTasks, int32* AmountOfPaintColorSnippetTasks);
...
static_assert(sizeof(UVertexPaintDetectionComponent) == 0x0001D0, "Wrong size on UVertexPaintDetectionComponent");
...
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsPaintedAtLocationDelegate) == 0x0000C0, "Member 'UVertexPaintDetectionComponent::VertexColorsPaintedAtLocationDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsPaintedMeshWithinAreaDelegate) == 0x0000D0, "Member 'UVertexPaintDetectionComponent::VertexColorsPaintedMeshWithinAreaDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsPaintedEntireMeshDelegate) == 0x0000E0, "Member 'UVertexPaintDetectionComponent::VertexColorsPaintedEntireMeshDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsPaintColorSnippetDelegate) == 0x0000F0, "Member 'UVertexPaintDetectionComponent::VertexColorsPaintColorSnippetDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsSetMeshColorsDelegate) == 0x000100, "Member 'UVertexPaintDetectionComponent::VertexColorsSetMeshColorsDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexColorsSetMeshColorsUsingSerializedStringDelegate) == 0x000110, "Member 'UVertexPaintDetectionComponent::VertexColorsSetMeshColorsUsingSerializedStringDelegate' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, PrintLogsToScreen) == 0x000120, "Member 'UVertexPaintDetectionComponent::PrintLogsToScreen' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, PrintLogsToScreen_Duration) == 0x000124, "Member 'UVertexPaintDetectionComponent::PrintLogsToScreen_Duration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, PrintLogsToOutputLog) == 0x000128, "Member 'UVertexPaintDetectionComponent::PrintLogsToOutputLog' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_drawVertexPositionDebugPoint) == 0x000129, "Member 'UVertexPaintDetectionComponent::AtGameThread_drawVertexPositionDebugPoint' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_drawVertexNormalDebugArrow) == 0x00012A, "Member 'UVertexPaintDetectionComponent::AtGameThread_drawVertexNormalDebugArrow' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_drawVertexPositionDebugPointOnVertexThatGotPaintApplied) == 0x00012B, "Member 'UVertexPaintDetectionComponent::AtGameThread_drawVertexPositionDebugPointOnVertexThatGotPaintApplied' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_drawClothVertexPositionDebugPoint) == 0x00012C, "Member 'UVertexPaintDetectionComponent::AtGameThread_drawClothVertexPositionDebugPoint' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_DrawVertexPointsDuration) == 0x000130, "Member 'UVertexPaintDetectionComponent::AtGameThread_DrawVertexPointsDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_DrawPaintConditionsDebugSymbols) == 0x000134, "Member 'UVertexPaintDetectionComponent::AtGameThread_DrawPaintConditionsDebugSymbols' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, AtGameThread_DrawPaintConditionsDebugSymbolsDuration) == 0x000138, "Member 'UVertexPaintDetectionComponent::AtGameThread_DrawPaintConditionsDebugSymbolsDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawGetClosestVertexDataDebugSymbols) == 0x00013C, "Member 'UVertexPaintDetectionComponent::DrawGetClosestVertexDataDebugSymbols' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawGetClosestVertexDataDebugSymbolsDuration) == 0x000140, "Member 'UVertexPaintDetectionComponent::DrawGetClosestVertexDataDebugSymbolsDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawGetEstimatedColorAtHitLocationDebugSymbols) == 0x000144, "Member 'UVertexPaintDetectionComponent::DrawGetEstimatedColorAtHitLocationDebugSymbols' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawGetEstimatedColorAtHitLocationDebugSymbolsDuration) == 0x000148, "Member 'UVertexPaintDetectionComponent::DrawGetEstimatedColorAtHitLocationDebugSymbolsDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawPaintWithinAreaDebugSymbols) == 0x00014C, "Member 'UVertexPaintDetectionComponent::DrawPaintWithinAreaDebugSymbols' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, DrawPaintWithinAreaDebugSymbolsDuration) == 0x000150, "Member 'UVertexPaintDetectionComponent::DrawPaintWithinAreaDebugSymbolsDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionComponent, VertexPaintGameInstanceSubsystem_Global) == 0x0001A8, "Member 'UVertexPaintDetectionComponent::VertexPaintGameInstanceSubsystem_Global' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             VertexPaintTaskFinished;                           // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             VertexDetectTaskFinished;                          // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMap<class UPrimitiveComponent*, struct FVertexPaintCalculateColorsQueueArrayStruct> CalculateColorsPaintQueue;                         // 0x0050(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<class UPrimitiveComponent*, struct FVertexPaintCalculateColorsQueueArrayStruct> CalculateColorsDetectionQueue;                     // 0x00A0(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<int32, struct FCalculateColorsInfo>      OnGoingAsyncTasks;                                 // 0x00F0(0x0050)(NativeAccessSpecifierPrivate)
	struct FTimerHandle                           VertexColorPaint_QueueThreadPool_ResetTimer;       // 0x0140(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWorld*                                 VertexColorPaint_QueueThreadPool_ResetTimerWorld;  // 0x0148(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_150[0x18];                                     // 0x0150(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTimerHandle>                   CleanupOldVertexColorBufferTimers;                 // 0x0168(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class UPrimitiveComponent*, int32>       MeshesPaintedOnSinceSessionStarted;                // 0x0178(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UPhysicalMaterial*>              CachedPhysicalMaterialAssets;                      // 0x01C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVertexPaintDetectionGISubSystem) == 0x0001D8, "Wrong size on UVertexPaintDetectionGISubSystem");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, VertexPaintTaskFinished) == 0x000030, "Member 'UVertexPaintDetectionGISubSystem::VertexPaintTaskFinished' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, VertexDetectTaskFinished) == 0x000040, "Member 'UVertexPaintDetectionGISubSystem::VertexDetectTaskFinished' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, CalculateColorsPaintQueue) == 0x000050, "Member 'UVertexPaintDetectionGISubSystem::CalculateColorsPaintQueue' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, CalculateColorsDetectionQueue) == 0x0000A0, "Member 'UVertexPaintDetectionGISubSystem::CalculateColorsDetectionQueue' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, OnGoingAsyncTasks) == 0x0000F0, "Member 'UVertexPaintDetectionGISubSystem::OnGoingAsyncTasks' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, VertexColorPaint_QueueThreadPool_ResetTimer) == 0x000140, "Member 'UVertexPaintDetectionGISubSystem::VertexColorPaint_QueueThreadPool_ResetTimer' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, VertexColorPaint_QueueThreadPool_ResetTimerWorld) == 0x000148, "Member 'UVertexPaintDetectionGISubSystem::VertexColorPaint_QueueThreadPool_ResetTimerWorld' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, CleanupOldVertexColorBufferTimers) == 0x000168, "Member 'UVertexPaintDetectionGISubSystem::CleanupOldVertexColorBufferTimers' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, MeshesPaintedOnSinceSessionStarted) == 0x000178, "Member 'UVertexPaintDetectionGISubSystem::MeshesPaintedOnSinceSessionStarted' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionGISubSystem, CachedPhysicalMaterialAssets) == 0x0001C8, "Member 'UVertexPaintDetectionGISubSystem::CachedPhysicalMaterialAssets' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UVertexPaintOptimizationDataAsset> VertexPaintAndDetectionPlugin_OptimizationDataAssetToUse; // 0x0038(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, Config, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UVertexPaintMaterialDataAsset> VertexPaintAndDetectionPlugin_MaterialsDataAssetToUse; // 0x0068(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, Config, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UVertexPaintColorSnippetRefs> VertexPaintAndDetectionPlugin_ColorSnippetReferencesDataAssetToUse; // 0x0098(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, Config, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VertexPaintAndDetectionPlugin_EditorWidgetNotificationEnabled; // 0x00C8(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C9[0x3];                                       // 0x00C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VertexPaintAndDetectionPlugin_EditorWidgetNotificationDuration; // 0x00CC(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         VertexPaintAndDetectionPlugin_MaxAmountOfAllowedTasksPerMesh; // 0x00D0(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVertexPaintDetectionSettings) == 0x0000D8, "Wrong size on UVertexPaintDetectionSettings");
...
static_assert(offsetof(UVertexPaintDetectionSettings, VertexPaintAndDetectionPlugin_MaterialsDataAssetToUse) == 0x000068, "Member 'UVertexPaintDetectionSettings::VertexPaintAndDetectionPlugin_MaterialsDataAssetToUse' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionSettings, VertexPaintAndDetectionPlugin_ColorSnippetReferencesDataAssetToUse) == 0x000098, "Member 'UVertexPaintDetectionSettings::VertexPaintAndDetectionPlugin_ColorSnippetReferencesDataAssetToUse' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionSettings, VertexPaintAndDetectionPlugin_EditorWidgetNotificationEnabled) == 0x0000C8, "Member 'UVertexPaintDetectionSettings::VertexPaintAndDetectionPlugin_EditorWidgetNotificationEnabled' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionSettings, VertexPaintAndDetectionPlugin_EditorWidgetNotificationDuration) == 0x0000CC, "Member 'UVertexPaintDetectionSettings::VertexPaintAndDetectionPlugin_EditorWidgetNotificationDuration' has a wrong offset!");
static_assert(offsetof(UVertexPaintDetectionSettings, VertexPaintAndDetectionPlugin_MaxAmountOfAllowedTasksPerMesh) == 0x0000D0, "Member 'UVertexPaintDetectionSettings::VertexPaintAndDetectionPlugin_MaxAmountOfAllowedTasksPerMesh' has a wrong offset!");
...
{
public:
	static void AdjustBoxCollisionToFitAreaBetweenPaintAtLocations(class UBoxComponent* boxCollision, const struct FVector& FromLocation, const struct FVector& ToLocation, float PaintAtLocationAreaOfAffect);
	...
	static bool GetColorsToApplyFromPhysicsSurface_Wrapper(class UMaterialInterface* MaterialToApplyColorsTo, EPhysicalSurface PhysicalSurface, float* RedAmountToApply, float* GreenAmountToApply, float* blueAmountToApply, float* AlphaAmountToApply, float DefaultAmountIfFailOrChannelIsNotRegistered);
	...
	static void MultiCapsuleTraceForClosestUniqueMeshes_Wrapper(const class UObject* WorldContextObject, const struct FVector& Location, const float& Radius, ETraceTypeQuery TraceChannel, const TArray<EObjectTypeQuery>& ObjectTypesToTraceFor, const TArray<class AActor*>& ActorsToIgnore, EDrawDebugTrace DrawDebugType, TArray<struct FHitResult>* ClosestHitsWithUniqueMeshes, float DebugDrawTime, bool IgnoreSelf, bool TraceComplex);
