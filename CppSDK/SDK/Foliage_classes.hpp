...
{
public:
	FMulticastInlineDelegateProperty_             OnInstanceTakePointDamage;                         // 0x08F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInstanceTakeRadialDamage;                        // 0x0908(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         BitPad_84_6 : 2;                                   // 0x0084(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
