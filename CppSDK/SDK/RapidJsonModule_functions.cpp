...
class FString URapidJsonFunctionLibrary::SerializeFloat_Wrapper(float FloatValue)
{
	static class UFunction* Func = nullptr;
...
class FString URapidJsonFunctionLibrary::SerializeFName_Wrapper(class FName NameValue)
{
	static class UFunction* Func = nullptr;
...
class FString URapidJsonFunctionLibrary::SerializeFRotator_Wrapper(const struct FRotator& RotatorValue)
{
	static class UFunction* Func = nullptr;
...
class FString URapidJsonFunctionLibrary::SerializeFTransform_Wrapper(const struct FTransform& TransformValue)
{
	static class UFunction* Func = nullptr;
...
class FString URapidJsonFunctionLibrary::SerializeFVector_Wrapper(const struct FVector& VectorValue)
{
	static class UFunction* Func = nullptr;
