...
public:
	...
	uint8                                         Pad_57D[0xB];                                      // 0x057D(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5B8[0xE8];                                     // 0x05B8(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMotionControllerComponent) == 0x0006A0, "Wrong size on UMotionControllerComponent");
...
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x00057C, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, bDisplayDeviceModel) == 0x000588, "Member 'UMotionControllerComponent::bDisplayDeviceModel' has a wrong offset!");
...
static_assert(offsetof(UXRDeviceVisualizationComponent, bIsVisualizationActive) == 0x000620, "Member 'UXRDeviceVisualizationComponent::bIsVisualizationActive' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayModelSource) == 0x000624, "Member 'UXRDeviceVisualizationComponent::DisplayModelSource' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, CustomDisplayMesh) == 0x000630, "Member 'UXRDeviceVisualizationComponent::CustomDisplayMesh' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayMeshMaterialOverrides) == 0x000638, "Member 'UXRDeviceVisualizationComponent::DisplayMeshMaterialOverrides' has a wrong offset!");
