...
public:
	...
	uint8                                         BitPad_EC_4 : 4;                                   // 0x00EC(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	...
	uint8                                         BitPad_F4_1 : 7;                                   // 0x00F4(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
...
static_assert(offsetof(ALandscapeProxy, bVirtualTextureRenderWithQuad) == 0x000331, "Member 'ALandscapeProxy::bVirtualTextureRenderWithQuad' has a wrong offset!");
static_assert(offsetof(ALandscapeProxy, bVirtualTextureRenderWithQuadHQ) == 0x000332, "Member 'ALandscapeProxy::bVirtualTextureRenderWithQuadHQ' has a wrong offset!");
...
static_assert(offsetof(ULandscapeComponent, BakedTextureMaterialGuid) == 0x0006DC, "Member 'ULandscapeComponent::BakedTextureMaterialGuid' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, LastBakedTextureMaterialGuid) == 0x0006EC, "Member 'ULandscapeComponent::LastBakedTextureMaterialGuid' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, GIBakedBaseColorTexture) == 0x000700, "Member 'ULandscapeComponent::GIBakedBaseColorTexture' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterface) == 0x000708, "Member 'ULandscapeComponent::MobileMaterialInterface' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterfaces) == 0x000710, "Member 'ULandscapeComponent::MobileMaterialInterfaces' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, MobileWeightmapTextures) == 0x000720, "Member 'ULandscapeComponent::MobileWeightmapTextures' has a wrong offset!");
...
static_assert(sizeof(ULandscapeMaterialInstanceConstant) == 0x000248, "Wrong size on ULandscapeMaterialInstanceConstant");
static_assert(offsetof(ULandscapeMaterialInstanceConstant, TextureStreamingInfo) == 0x000230, "Member 'ULandscapeMaterialInstanceConstant::TextureStreamingInfo' has a wrong offset!");
...
static_assert(offsetof(ALandscapeStreamingProxy, LandscapeActorRef) == 0x0005E0, "Member 'ALandscapeStreamingProxy::LandscapeActorRef' has a wrong offset!");
