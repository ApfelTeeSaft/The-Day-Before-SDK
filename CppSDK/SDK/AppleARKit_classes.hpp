...
static_assert(sizeof(UAppleARKitTextureCameraImage) == 0x000200, "Wrong size on UAppleARKitTextureCameraImage");
...
static_assert(sizeof(UAppleARKitTextureCameraDepth) == 0x000200, "Wrong size on UAppleARKitTextureCameraDepth");
...
static_assert(sizeof(UAppleARKitOcclusionTexture) == 0x000200, "Wrong size on UAppleARKitOcclusionTexture");
...
static_assert(sizeof(UAppleARKitCameraVideoTexture) == 0x000200, "Wrong size on UAppleARKitCameraVideoTexture");
