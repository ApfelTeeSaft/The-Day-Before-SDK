...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x000190, "Wrong size on FAnimNode_PoseDriver");
...
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x000120, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
...
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000CE0, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	uint8                                         Pad_2F6[0x6AA];                                    // 0x02F6(0x06AA)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
