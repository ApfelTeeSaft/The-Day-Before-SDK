...
static_assert(offsetof(FEnhancedActionKeyMapping, SettingBehavior) == 0x000081, "Member 'FEnhancedActionKeyMapping::SettingBehavior' has a wrong offset!");
static_assert(offsetof(FEnhancedActionKeyMapping, PlayerMappableKeySettings) == 0x000088, "Member 'FEnhancedActionKeyMapping::PlayerMappableKeySettings' has a wrong offset!");
