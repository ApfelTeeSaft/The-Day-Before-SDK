...
static_assert(sizeof(FRigVMFunction_DebugLine) == 0x0001C0, "Wrong size on FRigVMFunction_DebugLine");
static_assert(offsetof(FRigVMFunction_DebugLine, A) == 0x000100, "Member 'FRigVMFunction_DebugLine::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, B) == 0x000118, "Member 'FRigVMFunction_DebugLine::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, Color) == 0x000130, "Member 'FRigVMFunction_DebugLine::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, Thickness) == 0x000140, "Member 'FRigVMFunction_DebugLine::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, Space) == 0x000144, "Member 'FRigVMFunction_DebugLine::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, WorldOffset) == 0x000150, "Member 'FRigVMFunction_DebugLine::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, bEnabled) == 0x0001B0, "Member 'FRigVMFunction_DebugLine::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLineStrip) == 0x0001A0, "Wrong size on FRigVMFunction_DebugLineStrip");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Points) == 0x000100, "Member 'FRigVMFunction_DebugLineStrip::Points' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Color) == 0x000110, "Member 'FRigVMFunction_DebugLineStrip::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Thickness) == 0x000120, "Member 'FRigVMFunction_DebugLineStrip::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Space) == 0x000124, "Member 'FRigVMFunction_DebugLineStrip::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, WorldOffset) == 0x000130, "Member 'FRigVMFunction_DebugLineStrip::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, bEnabled) == 0x000190, "Member 'FRigVMFunction_DebugLineStrip::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransform) == 0x000110, "Wrong size on FRigVMFunction_DebugTransform");
...
static_assert(offsetof(FRigVMFunction_DebugTransform, Mode) == 0x000070, "Member 'FRigVMFunction_DebugTransform::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, Color) == 0x000074, "Member 'FRigVMFunction_DebugTransform::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, Thickness) == 0x000084, "Member 'FRigVMFunction_DebugTransform::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, Scale) == 0x000088, "Member 'FRigVMFunction_DebugTransform::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, Space) == 0x00008C, "Member 'FRigVMFunction_DebugTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, WorldOffset) == 0x0000A0, "Member 'FRigVMFunction_DebugTransform::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransform, bEnabled) == 0x000100, "Member 'FRigVMFunction_DebugTransform::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformMutable) == 0x000200, "Wrong size on FRigVMFunction_DebugTransformMutable");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Transform) == 0x000100, "Member 'FRigVMFunction_DebugTransformMutable::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Mode) == 0x000160, "Member 'FRigVMFunction_DebugTransformMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Color) == 0x000164, "Member 'FRigVMFunction_DebugTransformMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Thickness) == 0x000174, "Member 'FRigVMFunction_DebugTransformMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Scale) == 0x000178, "Member 'FRigVMFunction_DebugTransformMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Space) == 0x00017C, "Member 'FRigVMFunction_DebugTransformMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, WorldOffset) == 0x000190, "Member 'FRigVMFunction_DebugTransformMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, bEnabled) == 0x0001F0, "Member 'FRigVMFunction_DebugTransformMutable::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutable) == 0x0001C0, "Wrong size on FRigVMFunction_DebugTransformArrayMutable");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Transforms) == 0x000100, "Member 'FRigVMFunction_DebugTransformArrayMutable::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Mode) == 0x000110, "Member 'FRigVMFunction_DebugTransformArrayMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Color) == 0x000114, "Member 'FRigVMFunction_DebugTransformArrayMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Thickness) == 0x000124, "Member 'FRigVMFunction_DebugTransformArrayMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Scale) == 0x000128, "Member 'FRigVMFunction_DebugTransformArrayMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Space) == 0x00012C, "Member 'FRigVMFunction_DebugTransformArrayMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, WorldOffset) == 0x000140, "Member 'FRigVMFunction_DebugTransformArrayMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, bEnabled) == 0x0001A0, "Member 'FRigVMFunction_DebugTransformArrayMutable::bEnabled' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, WorkData) == 0x0001A8, "Member 'FRigVMFunction_DebugTransformArrayMutable::WorkData' has a wrong offset!");
