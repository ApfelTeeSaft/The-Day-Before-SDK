...
static_assert(sizeof(AFMODAmbientSound) == 0x000298, "Wrong size on AFMODAmbientSound");
static_assert(offsetof(AFMODAmbientSound, AudioComponent) == 0x000290, "Member 'AFMODAmbientSound::AudioComponent' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnEventStopped;                                    // 0x0310(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSoundStopped;                                    // 0x0320(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTimelineMarker;                                  // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTimelineBeat;                                    // 0x0340(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_35F[0xE1];                                     // 0x035F(0x00E1)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFMODAudioComponent) == 0x000440, "Wrong size on UFMODAudioComponent");
static_assert(offsetof(UFMODAudioComponent, Event) == 0x0002A0, "Member 'UFMODAudioComponent::Event' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ParameterCache) == 0x0002A8, "Member 'UFMODAudioComponent::ParameterCache' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ProgrammerSoundName) == 0x0002F8, "Member 'UFMODAudioComponent::ProgrammerSoundName' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnEventStopped) == 0x000310, "Member 'UFMODAudioComponent::OnEventStopped' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnSoundStopped) == 0x000320, "Member 'UFMODAudioComponent::OnSoundStopped' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnTimelineMarker) == 0x000330, "Member 'UFMODAudioComponent::OnTimelineMarker' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnTimelineBeat) == 0x000340, "Member 'UFMODAudioComponent::OnTimelineBeat' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, AttenuationDetails) == 0x000350, "Member 'UFMODAudioComponent::AttenuationDetails' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OcclusionDetails) == 0x00035C, "Member 'UFMODAudioComponent::OcclusionDetails' has a wrong offset!");
...
static_assert(sizeof(UFMODEventControlSection) == 0x0001F8, "Wrong size on UFMODEventControlSection");
static_assert(offsetof(UFMODEventControlSection, ControlKeys) == 0x0000F0, "Member 'UFMODEventControlSection::ControlKeys' has a wrong offset!");
...
static_assert(sizeof(UFMODEventControlTrack) == 0x0000B0, "Wrong size on UFMODEventControlTrack");
static_assert(offsetof(UFMODEventControlTrack, ControlSections) == 0x0000A0, "Member 'UFMODEventControlTrack::ControlSections' has a wrong offset!");
...
static_assert(sizeof(UFMODEventParameterTrack) == 0x0000B0, "Wrong size on UFMODEventParameterTrack");
static_assert(offsetof(UFMODEventParameterTrack, Sections) == 0x0000A0, "Member 'UFMODEventParameterTrack::Sections' has a wrong offset!");
