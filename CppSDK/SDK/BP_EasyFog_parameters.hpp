...
{
public:
	class UPrimitiveComponent*                    Param_FogCard;                                     // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_EasyFog_C_UserConstructionScript, Param_FogCard) == 0x000000, "Member 'BP_EasyFog_C_UserConstructionScript::Param_FogCard' has a wrong offset!");
