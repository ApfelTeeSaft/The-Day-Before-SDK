...
public:
	...
	uint8                                         Pad_83[0xED];                                      // 0x0083(0x00ED)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FObservedComponent, bPlaybackEnabled) == 0x000082, "Member 'FObservedComponent::bPlaybackEnabled' has a wrong offset!");
