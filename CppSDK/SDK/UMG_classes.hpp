...
static_assert(sizeof(UListView) == 0x000C30, "Wrong size on UListView");
...
static_assert(offsetof(UListView, BP_OnListViewScrolled) == 0x000C20, "Member 'UListView::BP_OnListViewScrolled' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnUserScrolled;                                    // 0x0C90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTileView) == 0x000C50, "Wrong size on UTileView");
static_assert(offsetof(UTileView, EntryHeight) == 0x000C30, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000C34, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000C38, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000C39, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             BP_OnItemExpansionChanged;                         // 0x0C50(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTreeView) == 0x000C90, "Wrong size on UTreeView");
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000C40, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000C50, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnSelectionChanged;                                // 0x1CE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOpening;                                         // 0x1CF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnSelectionChanged;                                // 0x1D28(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOpening;                                         // 0x1D38(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x000674, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x000678, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x00067C, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickMode) == 0x000680, "Member 'UWidgetComponent::TickMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Widget) == 0x0006B0, "Member 'UWidgetComponent::Widget' has a wrong offset!");
