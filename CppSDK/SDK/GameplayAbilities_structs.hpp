...
static_assert(sizeof(FGameplayModifierInfo) == 0x0002A8, "Wrong size on FGameplayModifierInfo");
...
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000268, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
