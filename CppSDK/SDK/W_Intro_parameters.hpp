...
static_assert(sizeof(W_Intro_C_ExecuteUbergraph_W_Intro) == 0x000010, "Wrong size on W_Intro_C_ExecuteUbergraph_W_Intro");
...
static_assert(offsetof(W_Intro_C_ExecuteUbergraph_W_Intro, CallFunc_PlayAnimationForward_ReturnValue) == 0x000008, "Member 'W_Intro_C_ExecuteUbergraph_W_Intro::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
