...
void UVertexPaintDetectionComponent::GetCurrentTasksInitiatedByComponent(int32* TotalAmountOfTasks, int32* AmountOfGetClosestVertexDataTasks, int32* AmountOfGetAllVertexColorsOnlyTasks, int32* AmountOfPaintAtLocationTasks, int32* AmountOfPaintWithinAreaTasks, int32* AmountOfPaintEntireMeshTasks, int32* AmountOfPaintColorSnippetTasks)
{
	static class UFunction* Func = nullptr;
...
// struct FVertexPaintStruct               PaintedOnActorSettings                                 (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
// struct FVertexDetectTaskResultInfo      TaskResultInfo                                         (Parm, NoDestructor, NativeAccessSpecifierPublic)
// struct FVertexDetectMeshDataStruct      MeshData                                               (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// struct FVertexDetectGetColorsOnlyStruct GotAllVertexColorsWithSettings                         (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// struct FVertexDetectAmountOfPaintedColorsOfEachChannelAmountOfPaintedColorsOfEachChannel                     (Parm, NoDestructor, NativeAccessSpecifierPublic)
// struct FVertexDetectVertexColorsOnEachBoneVertexColorsOnEachBone                                 (Parm, NativeAccessSpecifierPublic)
// struct FVertexDetectAdditionalDataToPassThroughAdditionalData                                         (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
// float                                   PaintAtLocationAreaOfAffect                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UVertexPaintFunctionLibrary::AdjustBoxCollisionToFitAreaBetweenPaintAtLocations(class UBoxComponent* boxCollision, const struct FVector& FromLocation, const struct FVector& ToLocation, float PaintAtLocationAreaOfAffect)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("VertexPaintFunctionLibrary", "AdjustBoxCollisionToFitAreaBetweenPaintAtLocations");

	Params::VertexPaintFunctionLibrary_AdjustBoxCollisionToFitAreaBetweenPaintAtLocations Parms{};

	Parms.boxCollision = boxCollision;
	Parms.FromLocation = std::move(FromLocation);
	Parms.ToLocation = std::move(ToLocation);
	Parms.PaintAtLocationAreaOfAffect = PaintAtLocationAreaOfAffect;
...
// class UPrimitiveComponent*              MeshComponent                                          (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVertexDetectGetColorsOnlyStruct GetAllVertexColorsStruct                               (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
bool UVertexPaintFunctionLibrary::GetColorsToApplyFromPhysicsSurface_Wrapper(class UMaterialInterface* MaterialToApplyColorsTo, EPhysicalSurface PhysicalSurface, float* RedAmountToApply, float* GreenAmountToApply, float* blueAmountToApply, float* AlphaAmountToApply, float DefaultAmountIfFailOrChannelIsNotRegistered)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("VertexPaintFunctionLibrary", "GetColorsToApplyFromPhysicsSurface_Wrapper");

	Params::VertexPaintFunctionLibrary_GetColorsToApplyFromPhysicsSurface_Wrapper Parms{};
...
// TArray<struct FHitResult>               ClosestHitsWithUniqueMeshes                            (Parm, OutParm, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
void UVertexPaintFunctionLibrary::MultiCapsuleTraceForClosestUniqueMeshes_Wrapper(const class UObject* WorldContextObject, const struct FVector& Location, const float& Radius, ETraceTypeQuery TraceChannel, const TArray<EObjectTypeQuery>& ObjectTypesToTraceFor, const TArray<class AActor*>& ActorsToIgnore, EDrawDebugTrace DrawDebugType, TArray<struct FHitResult>* ClosestHitsWithUniqueMeshes, float DebugDrawTime, bool IgnoreSelf, bool TraceComplex)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("VertexPaintFunctionLibrary", "MultiCapsuleTraceForClosestUniqueMeshes_Wrapper");

	Params::VertexPaintFunctionLibrary_MultiCapsuleTraceForClosestUniqueMeshes_Wrapper Parms{};
	...
	if (ClosestHitsWithUniqueMeshes != nullptr)
		*ClosestHitsWithUniqueMeshes = std::move(Parms.ClosestHitsWithUniqueMeshes);
}
